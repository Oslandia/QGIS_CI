...
class _3D_EXPORT QgsPhongMaterialSettings : public QgsAbstractMaterialSettings
{
...
#ifndef SIP_RUN
    Qt3DRender::QMaterial *toMaterial( const Qgs3DMapSettings *mapSettings, QgsMaterialSettingsRenderingTechnique technique, const QgsMaterialContext &context ) const override SIP_FACTORY;
  ...
  private:
    ...
    Qt3DRender::QMaterial *dataDefinedMaterial( const Qgs3DMapSettings *mapSettings ) const;
};
